...
int main()
{
    ...
    // Axis::x means horizontal// starting at (20,300)
    // 280 pixels long// 10 "notches" ("tick marks")
    // text "x axis"
    ...
    Axis ya(Axis::y, Point(20,300), 280, 10, "y axis");//280 divided by 10 = 28
    ...
    Closed_polyline poly_rect;poly_rect.add(Point(100,50));
    ...
    ostringstream oss;oss << "screen size: " << x_max() << "*" << y_max()
